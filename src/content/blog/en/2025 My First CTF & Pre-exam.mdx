...
import usersDb from "../../../assets/blog/2025_My_First_CTF_&_Pre-exam/users-db.png";
import businessIdQuery from "../../../assets/blog/2025_My_First_CTF_&_Pre-exam/營業人統一編號查詢.png";
import ramenOrderMachine from "../../../assets/blog/2025_My_First_CTF_&_Pre-exam/樂山溫泉拉麵-點餐機.png";
import welcomeImg from "../../../assets/blog/2025_My_First_CTF_&_Pre-exam/welcome.png";
import ghidra1 from "../../../assets/blog/2025_My_First_CTF_&_Pre-exam/Tiny-server-Ghidra-1.png";
import ghidra2 from "../../../assets/blog/2025_My_First_CTF_&_Pre-exam/Tiny-server-Ghidra-2.png";
...
<Image src={usersDb} alt="SQLite users database viewer" />
...
<Image src={businessIdQuery} alt="Business ID query result" />
...
<Image src={ramenOrderMachine} alt="Leshan Hot Spring Ramen ordering machine" />
...
<Image src={welcomeImg} alt="Welcome challenge screenshot" />
...
<Image src={ghidra1} alt="Ghidra decompilation screenshot 1" />
...
<Image src={ghidra2} alt="Ghidra decompilation screenshot 2" />
